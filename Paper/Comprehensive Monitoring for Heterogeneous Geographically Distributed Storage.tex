...
\input{section-2-site-info-providers.tex}
\input{section-3-site-client-software.tex}
\input{section-4-central-infrastructure.tex}
\input{section-5-deployment-campaign.tex}
\input{section-6-summary.tex}
% \input{section-7-....tex}
% \input{section-8-....tex}
